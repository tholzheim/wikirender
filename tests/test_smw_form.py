...
class TestSMWForm(unittest.TestCase):
    ...
    def test_form_standard_input_tag(self):
        ...
        self.assertEqual(exp_tag, Form.standard_input_tag("save", css_class="test", style="width:100%", label="Save Page"))
    ...
    def test_form_forminput(self):
        ...
        self.assertEqual(expected_forminput, Form.forminput("Event", size=25, placeholder="Enter Event", popup=True))
